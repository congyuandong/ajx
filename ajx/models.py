...
class Addition(models.Model):
    ...
    price = models.IntegerField(default =  2, verbose_name='价格')
...
class Route(models.Model):
    ...
    marketPrice = models.IntegerField(default =  0, verbose_name='市场价格')
    realPrice = models.IntegerField(default =  0, verbose_name='优惠价格')
    childPrice = models.IntegerField(default =  0, verbose_name='儿童价格', null = True, blank = True)
    ...
    singleRoom = models.IntegerField(default =  0, verbose_name = '单房价')
...
class GoDate(models.Model):
    ...
    price = models.IntegerField(default =  0, verbose_name='成人价格')
    childPrice = models.IntegerField(default =  0, verbose_name='儿童价格')
...
class Order(models.Model):
    ...
    amount = models.IntegerField(default =  0, verbose_name='总价')
