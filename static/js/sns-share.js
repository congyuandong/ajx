	...
	$.fn.xuanfengSnsShare = function(options){
		...
		var defaults = {
				tsina:{//分享到新浪微博 
					...
					appkey : '3544940105',								//xuanfeng新浪微博的appkey
				...
				tqq:{//分享到腾讯微博
					url : encodeURIComponent(window.location.href),							//分享的url默认是当前页面
					title : document.title,								//分享的内容默认是当前页面的title
					appkey : '101267652',									//xuanfeng腾讯微博的appkey
					pic : 'http://www.xuanfengge.com/wp-content/themes/lee2.0/images/piano.jpg'	//图片默认是xuanfeng-piano
				},
				tqzone:{//分享到QQ空间
					url : encodeURIComponent(window.location.href),							//分享的url默认是当前页面
			...
			shareUrl = {
				...
				tqzone : 'http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url={url}&pics={pic}&title={title}&summary=专注于东北旅游服务&showcount=1'
			};
